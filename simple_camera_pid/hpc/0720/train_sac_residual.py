...
a single fixed map — recommended after this session's generalization check
found a fixed-map-trained agent got WORSE than the plain PID baseline on an
unseen track:
...
def build_env(args) -> Monitor:
    ...
    if args.domain_rand:
        ...
        dr = DRConfig(map_enable=False, gen_track_enable=args.gen_track,
