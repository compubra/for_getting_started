...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'config', 'gazebo'),
            glob(os.path.join('config', 'gazebo', '*.yaml'))),
        ...
        (os.path.join('share', package_name, 'launch', 'gazebo'),
            glob(os.path.join('launch', 'gazebo', '*.launch.py'))),
    ...
    description='Camera-based PID + optional SAC/PPO residual line follower (Gazebo and MuJoCo).',
    license='TODO: License declaration',
    entry_points={
        'console_scripts': [
            'mujoco_line_follower_node = simple_camera_pid.mujoco.mujoco_line_follower_node:main',
            'gazebo_line_follower_node = simple_camera_pid.gazebo.gazebo_line_follower_node:main',
